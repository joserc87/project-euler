...
hasta es primo, se anadirá al vector
"""
...
def numFactorizaciones (l):
    cnt=1 # Contamos la factorización obvia (a*b*c..)
    nl=len(l)
    otrol=l
    for ncomps in range (2, nl):
        
    return cnt

primos =[]
print descomposicion (954, primos)
